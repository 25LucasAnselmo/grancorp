					...
					<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
						...
						<li class="wow animate fadeInUp">
							...
							<hgroup>
								...
								<p><?php the_excerpt(); ?></p>
								<a href="<?php the_permalink(); ?>" class="leia"><?php the_field('blog-texto_button'); ?> <i class="fa fa-angle-right"></i></a>
							</hgroup>
						</li>

					<?php endwhile; wp_reset_query(); ?>
				</ul>
				<a href="<?php echo home_url(); ?>/blog" class="postagens wow animate fadeInUp"><?= $fields['blog-todas']; ?></a>
			</div>
		</div>
	</div>
</section>